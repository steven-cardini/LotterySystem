...
public class TextResourcesDE extends ListResourceBundle {
	...
	protected Object[][] getContents() {
		return new Object[][] {
				...
				{ "console_main_menu", "A: Zahlen eingeben, B: Neue Gewinnerzahlen ziehen, H: Sprache ändern, Q: Programm beenden" },
				...
				{ "amount_matching_numbers", "Anzahl übereinstimmende Zahlen:" },
