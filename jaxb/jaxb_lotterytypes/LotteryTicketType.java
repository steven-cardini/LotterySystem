 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="next_draw_date" type="{http://www.w3.org/2001/XMLSchema}date"/>
 *         &lt;element ref="{http://www.ti.bfh.ch/euromillions/}validity"/>
 *       &lt;/sequence>
...
public class LotteryTicketType {
    ...
    @XmlElement(name = "next_draw_date", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar nextDrawDate;
    @XmlElement(namespace = "http://www.ti.bfh.ch/euromillions/")
    ...
    /**
     * Gets the value of the nextDrawDate property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public XMLGregorianCalendar getNextDrawDate() {
        return nextDrawDate;
    }

    /**
     * Sets the value of the nextDrawDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setNextDrawDate(XMLGregorianCalendar value) {
        this.nextDrawDate = value;
    }
